			...
			<div class="content-container">
				...
				<div class="content-body">
					<div class="row">
						<!----- INTRO ----->
						<div class="col-md-3">
							<img src="${basepath}/${newsCheck.picList[0].url}" alt="" style="width: 100%">
						</div>
						<div class="col-md-9">
							<div class="profile-content-text">
								<h3 class="name">${newsCheck.author}</h3>
								<h4 class="duty">${newsCheck.mainTitle }</h4>
								<h4 class="title">${newsCheck.secondTitle}</h4>
							</div>
						</div>
