		...
		<div class="col-md-10" style="margin-top: 40px; background-color: #FFF">
			...
			<div class="content-container">
				...
				<div class="content-body">
					<!--文章标题-->
					<h2 class="essay-headline">${newsCheck.mainTitle}</h2>
					<!--文章子标题-->
					<h3 class="essay-subheading">${newsCheck.secondTitle}</h3>
					<!--文章内容与细节-->
					...
					<div class="essay-author-date">
						<div>${newsCheck.author }</div>
						<div>
							<fmt:formatDate value="${newsCheck.createTime}" pattern="yyyy/MM/dd"></fmt:formatDate>
						</div>
					</div>
