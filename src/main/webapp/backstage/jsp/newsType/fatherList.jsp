              ...
              <div class="select-panel">
                ...
                <table class="table">
                  ...
                  <tbody style=" font-weight: normal;">
                   <c:forEach items="${newsTypeList}" var="father">        
                      <c:if test="${father.parentId eq '0'}">
                        <tr>           
                          <td align="center"> <a href="newsTypeInf_sonList.action?newsTypeId=${father.id}" target="iframe_son">${father.name}</a></td>
