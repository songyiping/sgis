					...
					<div class="col-md-12">
						<div class="square-widget">
							<div class="widget-container">
								...
								<form id="default" action="${basepath}/news/edit.do"
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
											<input type="text" value="${news.mainTitle}" name="mainTitle" class="form-control"
												maxlength="48">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
											<input type="text" value="${news.secondTitle}" name="secondTitle" class="form-control"
												maxlength="50">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6">
											超链接应该包含http:// 或https:// <input type="text" value="${news.text}" name="text"
