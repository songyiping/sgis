...
<!--表格开始标志  -->   <form action="${basepath}/news/edit.do" method="post" onsubmit="return checkFrm();">
        ...
        <!--  userId -->         <input type="hidden"   name="user.id" value="${news.user.id}"/>
         ...
         <!--  picId -->          <input type="hidden" id="test"  name="pic.id" value="${news.pic.id}" />
          <!--  author  -->        <input type="text" name="author"  class="form-control"  placeholder="姓名" maxlength = "20" value="${news.author}">
        <!--  mainTitle   -->    <input type="text"  name="mainTitle"   class="form-control"  placeholder="主要职务" maxlength = "50" value="${news.mainTitle}">
        <!--  secondTitle -->    <input type="text" name="secondTitle"  class="form-control"  placeholder="其他职务" maxlength = "50" value="${news.secondTitle}">
                                 ...
                                 <div class="fileupload-preview fileupload-exists thumbnail"></div>
                                   <div style=" margin-top: 10px; margin-bottom: 20px"> <span class="label label-warning">建议</span> <span>上传图片尺寸：200 × 150 px</span> </div>
